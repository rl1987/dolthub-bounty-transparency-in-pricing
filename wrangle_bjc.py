...
def convert_dataframe(df_in, ccn):
    ...
    df_mid = pd.melt(df_mid, id_vars=remaining_columns, 
                     var_name='payer_name2', value_name='standard_charge')

    df_mid['payer_category'] = df_mid['payer_name2'].apply(payer_category_from_payer_name)

    df_mid.loc[df_mid['payer_category'] != 'payer', 'payer_name'] = df_mid[df_mid['payer_category'] != 'payer']['payer_name2']
    del df_mid['payer_name2']

    df_mid.loc[df_mid['line_type'] == 'cpt', 'hcpcs_cpt'] = df_mid[df_mid['line_type'] == 'cpt']['code']
    df_mid.loc[df_mid['line_type'] == 'ms-drg', 'ms_drg'] = df_mid[df_mid['line_type'] == 'ms-drg']['code']
    df_mid.loc[df_mid['line_type'] == 'revCode', 'rev_code'] = df_mid[df_mid['line_type'] == 'revCode']['code']
    df_mid.loc[df_mid['line_type'] == 'ndc', 'ndc'] = df_mid[df_mid['line_type'] == 'ndc']['code']
